...
// InAppPurchasesApiInAppPurchasesGetInstanceOpts Optional parameters for the method 'InAppPurchasesGetInstance'
type InAppPurchasesApiInAppPurchasesGetInstanceOpts struct {
 ...
 * @param optional nil or *InAppPurchasesApiInAppPurchasesGetInstanceOpts - Optional Parameters:
...
*/
func (a *InAppPurchasesApiService) InAppPurchasesGetInstance(ctx _context.Context, id string, localVarOptionals *InAppPurchasesApiInAppPurchasesGetInstanceOpts) (InAppPurchaseResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/inAppPurchases/{id}"
