...
// CertificatesApiCertificatesGetCollectionOpts Optional parameters for the method 'CertificatesGetCollection'
type CertificatesApiCertificatesGetCollectionOpts struct {
	FilterCertificateType optional.Interface
	FilterDisplayName     optional.Interface
	FilterSerialNumber    optional.Interface
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CertificatesApiCertificatesGetCollectionOpts - Optional Parameters:
 * @param "FilterCertificateType" (optional.Interface of []string) -  filter by attribute 'certificateType'
 * @param "FilterDisplayName" (optional.Interface of []string) -  filter by attribute 'displayName'
 * @param "FilterSerialNumber" (optional.Interface of []string) -  filter by attribute 'serialNumber'
...
// CertificatesApiCertificatesGetInstanceOpts Optional parameters for the method 'CertificatesGetInstance'
type CertificatesApiCertificatesGetInstanceOpts struct {
	FieldsCertificates optional.Interface
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id the id of the requested resource
 * @param optional nil or *CertificatesApiCertificatesGetInstanceOpts - Optional Parameters:
 * @param "FieldsCertificates" (optional.Interface of []string) -  the fields to include for returned resources of type certificates
@return CertificateResponse
*/
