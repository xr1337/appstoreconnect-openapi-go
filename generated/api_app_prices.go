...
// AppPricesApiAppPricesGetInstanceOpts Optional parameters for the method 'AppPricesGetInstance'
type AppPricesApiAppPricesGetInstanceOpts struct {
 ...
 * @param optional nil or *AppPricesApiAppPricesGetInstanceOpts - Optional Parameters:
...
*/
func (a *AppPricesApiService) AppPricesGetInstance(ctx _context.Context, id string, localVarOptionals *AppPricesApiAppPricesGetInstanceOpts) (AppPriceResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/appPrices/{id}"
